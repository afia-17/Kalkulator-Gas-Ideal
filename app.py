...
# ===========================================
# BACKGROUND DINAMIS BERDASARKAN MENU
# ===========================================
# Menentukan gambar latar belakang berdasarkan menu yang dipilih
background_images = {
    "🏠 Beranda": "bg_home.jpg", # Ganti dengan path gambar Anda
    "🧮 Kalkulator Gas": "bg_calculator.jpg", # Ganti dengan path gambar Anda
    "📚 Ensiklopedia Gas": "bg_encyclopedia.jpg", # Ganti dengan path gambar Anda
    "⚠️ Panduan Keselamatan": "bg_safety.jpg" # Ganti dengan path gambar Anda
}

# Path ke folder gambar Anda (pastikan folder ini ada dan berisi gambar)
IMAGE_FOLDER = "backgrounds/" # Contoh: buat folder 'backgrounds' di direktori yang sama

# Pilih gambar latar belakang
selected_menu = st.session_state.get('menu', "🏠 Beranda") # Default ke Beranda jika belum ada state
bg_image_path = IMAGE_FOLDER + background_images.get(selected_menu, "bg_default.jpg") # Default image

# Coba konversi gambar ke base64, fallback ke warna solid jika gagal
try:
    ...
    /* Menambahkan lapisan semi-transparan untuk meningkatkan kontras teks */
    .main-content {{
    ...
    # Jika gambar tidak ditemukan, gunakan gradien sebagai fallback
    background_style = """
    <style>
    .stApp {{
        background: linear-gradient(135deg, #74ebd5, #ACB6E5); /* Gradien fallback */
    }}
    .main-content {{
    ...
    """
    st.warning("Gambar latar belakang tidak ditemukan. Menggunakan tema warna default.")

st.markdown(background_style, unsafe_allow_html=True)

# ===========================================
# CSS CUSTOM (dengan penyesuaian untuk kontras)
# ===========================================
st.markdown("""
<style>
    .main-header {
    ...
    .card {
        ...
        margin-bottom: 20px;
        background-color: rgba(255, 255, 255, 0.95); /* Latar belakang kartu lebih solid */
    }
    .calc-card {
    ...
    .property-table {
        ...
        background-color: rgba(255, 255, 255, 0.9); /* Latar belakang tabel */
    }
    .property-table th {
    ...
    /* CSS untuk Kalkulator Gas - Partikel */
    @keyframes float {
    ...
    /* CSS untuk Ensiklopedia Gas - Hover Effect */
    .gas-selectbox:hover {
        transform: scale(1.02);
        transition: transform 0.2s ease-in-out;
    }

    /* CSS untuk Panduan Keselamatan - Icon Animation */
    .safety-icon {
    ...
    .footer-content {
        ...
        padding: 10px 0;
        z-index: 9999;
        backdrop-filter: blur(5px); /* Efek blur untuk footer */
    }
...
with st.sidebar:
    ...
    st.markdown("---")
    # Simpan state menu yang dipilih
    menu = st.radio(
        "MENU UTAMA",
        ["🏠 Beranda", "🧮 Kalkulator Gas", "📚 Ensiklopedia Gas", "⚠️ Panduan Keselamatan"],
        index=0,
        key='menu_radio' # Tambahkan key untuk tracking
    )
    # Update state menu
...
# ===========================================
if menu == "🏠 Beranda":
    st.markdown("<div class='main-content'>", unsafe_allow_html=True) # Wrapper konten utama
    ...
    """, unsafe_allow_html=True)
    st.markdown("</div>", unsafe_allow_html=True) # Tutup wrapper konten utama
...
# ===========================================
    ...
    # Tambahkan class untuk styling selectbox
    st.markdown('<div class="gas-selectbox">', unsafe_allow_html=True)
...
# ===========================================
    ...
    <div class="card safety-card">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:15px;margin-top:15px;">
            <div style="flex:1;min-width:200px;background:#ffebee;padding:15px;border-radius:10px;" class="safety-icon">
                <h4>🔥 Mudah Terbakar</h4>
                <p>Contoh: Hidrogen, Metana</p>
                <p>• Jauhkan dari sumber api</p>
                <p>• Gunakan di area berventilasi</p>
            </div>
            <div style="flex:1;min-width:200px;background:#fff8e1;padding:15px;border-radius:10px;" class="safety-icon">
                <h4>☠️ Beracun</h4>
                <p>Contoh: Klorin, Amonia</p>
                <p>• Gunakan alat pelindung diri</p>
                <p>• Hindari inhalasi langsung</p>
            </div>
            <div style="flex:1;min-width:200px;background:#e8f5e9;padding:15px;border-radius:10px;" class="safety-icon">
                <h4>💨 Pengoksidasi</h4>
    ...
    <div class="card safety-card">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:15px;margin-top:15px;">
            <div style="flex:1;min-width:150px;text-align:center;" class="safety-icon">
