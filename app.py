...
<style>
    ...
    /* Background sederhana untuk setiap menu */
    .menu-beranda {
        background: linear-gradient(rgba(255,255,255,0.9), rgba(255,255,255,0.9)), 
                   url('https://picsum.photos/seed/chemlab/1200/800.jpg');
    ...
    .menu-kalkulator {
        background: linear-gradient(rgba(255,255,255,0.9), rgba(255,255,255,0.9)), 
                   url('https://picsum.photos/seed/calculator/1200/800.jpg');
        background-size: cover;
        background-position: center;
        padding: 30px;
        border-radius: 15px;
    ...
    .menu-ensiklopedia {
        background: linear-gradient(rgba(255,255,255,0.9), rgba(255,255,255,0.9)), 
                   url('https://picsum.photos/seed/books/1200/800.jpg');
        background-size: cover;
        background-position: center;
        padding: 30px;
        border-radius: 15px;
    ...
    .menu-keselamatan {
        background: linear-gradient(rgba(255,255,255,0.9), rgba(255,255,255,0.9)), 
                   url('https://picsum.photos/seed/safety/1200/800.jpg');
        background-size: cover;
        background-position: center;
        padding: 30px;
        border-radius: 15px;
...
if menu == "🏠 Beranda":
    ...
    <div class="menu-beranda">
        <h1 class="main-header">ChemGasMaster</h1>
    """, unsafe_allow_html=True)
...
# ===========================================
    ...
    st.markdown("""
    <div class="menu-kalkulator">
        <h1 class="main-header">🧪✨ Kalkulator Gas Ideal ✨⚗️</h1>
    """, unsafe_allow_html=True)
    
    # Kalkulator Gas Ideal dengan penjelasan
    with st.container():
        st.markdown("""
        <div style="padding: 20px; background: white; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                ...
                <div>
                    <h2 style="margin: 0; color: #0d47a1;">Kalkulator Gas Ideal</h2>
                    <div style="background: #E3F2FD; padding: 8px 12px; border-radius: 8px; display: inline-block;">
                        <b>Rumus:</b> PV=nRT (R=0.0821 L·atm/mol·K)
                    </div>
                </div>
            </div>
        """, unsafe_allow_html=True)
        ...
        st.markdown('<div class="input-label" style="margin-top: 15px;">Massa Molar (Mr)</div>', unsafe_allow_html=True)
    ...
    with st.container():
        ...
        <div style="padding: 20px; background: white; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                ...
                <div>
                    <h2 style="margin: 0; color: #0d47a1;">Kalkulator Tekanan Gas</h2>
                    <div style="background: #E3F2FD; padding: 8px 12px; border-radius: 8px; display: inline-block;">
        ...
        with col2:
            ...
            with col2c:
                P_input = st.number_input("Tekanan", min_value=0.0, key="tekanan_vol_input", label_visibility="collapsed")
            with col2d:
                satuan_vol = st.selectbox("Satuan Tekanan", ["atm", "Pa", "kPa", "hPa", "bar", "Torr", "mmHg"], key="tekanan_vol_unit", label_visibility="collapsed")
            
            if satuan_vol == "m³":
                V = P_input * 1000
                st.markdown(f"""
                <div class="conversion-box">
                    🔄 Konversi: {P_input} m³ = {V:.4f} L
                </div>
                """, unsafe_allow_html=True)
            elif satuan_vol == "mL":
                V = P_input / 1000
        ...
        if st.button("🎚️ Hitung Tekanan", key="btn_tekanan", use_container_width=True, type="primary"):
            ...
            <div style="background: linear-gradient(135deg, #E3F2FD, #BBDEFB);
                ...
                <div style="display: flex; align-items: center; gap: 15px;">
                    <div style="font-size: 30px;">🎚️</div>
                    <div>
                        <h3 style="margin: 0 0 10px 0; color: #0D47A1;">Hasil Perhitungan</h3>
                        <div style="display: flex; align-items: baseline; gap: 10px;">
                            <p style="margin: 0; font-size: 1.2em;">Tekanan <b>{nama if nama else 'gas'}</b> =</p>
                            <p style="color: #0D47A1; font-weight: bold; font-size: 1.5em; margin: 0;">{P:.2f} atm</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    with st.container():
        ...
        <div style="padding: 20px; background: white; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                <div style="font-size: 40px;">🫙</div>
                <div>
                    <h2 style="margin: 0; color: #0d47a1;">Kalkulator Volume Gas</h2>
                    <div style="background: #E3F2FD; padding: 8px 12px; border-radius: 8px; display: inline-block;">
    ...
    with st.container():
        ...
        <div style="padding: 20px; background: white; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
                <div style="font-size: 40px;">🧪 </div>
                <div>
                    <h2 style="margin: 0; color: #0d47a1;">Kalkulator Jumlah Mol</h2>
                    <div style="background: #E3F2FD; padding: 8px 12px; border-radius: 8px; display: inline-block;">
...
# ===========================================
    ...
    st.markdown("""
    <div class="menu-ensiklopedia">
        <h1 class="main-header">📚 Ensiklopedia Gas</h1>
    """, unsafe_allow_html=True)
...
# ===========================================
    ...
    st.markdown("""
    <div class="menu-keselamatan">
        <h1 class="main-header">⚠️ Panduan Keselamatan Gas</h1>
    """, unsafe_allow_html=True)
