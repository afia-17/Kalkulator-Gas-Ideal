...
<style>
    ...
    @keyframes lightning {
        ...
        5%, 10% { background-color: rgba(255, 255, 0, 0.3); }
    }

    /* BERANDA - Enhanced Molecular Theme */
    .beranda-bg {
    ...
    .beranda-bg::after {
        ...
        bottom: 0;
        background-image: 
            radial-gradient(circle at 20% 30%, rgba(255,255,255,0.3) 4px, transparent 4px),
            radial-gradient(circle at 70% 80%, rgba(255,255,255,0.2) 6px, transparent 6px),
            radial-gradient(circle at 40% 60%, rgba(255,255,255,0.25) 3px, transparent 3px),
            radial-gradient(circle at 90% 20%, rgba(255,255,255,0.15) 5px, transparent 5px);
        background-size: 150px 150px, 200px 200px, 100px 100px, 180px 180px;
        animation: molecule-rotate 12s linear infinite;
    }

    /* KALKULATOR - Enhanced Laboratory Theme */
    .kalkulator-bg {
    ...
    /* ENSIKLOPEDIA - Enhanced Library Theme */
    .ensiklopedia-bg {
        background: linear-gradient(45deg, 
            #ff9a9e 0%,
            #fecfef 25%,  
    ...
    /* KESELAMATAN - Enhanced Warning Theme */
    .keselamatan-bg {
        background: linear-gradient(135deg, 
            #ff7675 0%,
            #fd79a8 20%,
    ...
    .keselamatan-bg::before {
        ...
        background-image: 
            ...
            repeating-conic-gradient(from 90deg at 70% 70%, 
                transparent 0deg 45deg, 
                rgba(255,255,255,0.08) 45deg 90deg);
    ...
    .particle:nth-child(1) { left: 10%; width: 25px; height: 25px; animation-delay: 0s; }
    .particle:nth-child(2) { left: 20%; width: 20px; height: 20px; animation-delay: 3s; }
    .particle:nth-child(3) { left: 30%; width: 30px; height: 30px; animation-delay: 6s; }
    .particle:nth-child(4) { left: 40%; width: 15px; height: 15px; animation-delay: 9s; }
    .particle:nth-child(5) { left: 50%; width: 22px; height: 22px; animation-delay: 12s; }
    .particle:nth-child(6) { left: 60%; width: 28px; height: 28px; animation-delay: 15s; }
    .particle:nth-child(7) { left: 70%; width: 18px; height: 18px; animation-delay: 18s; }
    .particle:nth-child(8) { left: 80%; width: 24px; height: 24px; animation-delay: 21s; }
    .particle:nth-child(9) { left: 90%; width: 26px; height: 26px; animation-delay: 24s; }

    /* Enhanced card styling with better backdrop */
    .main-header {
        color: #0d47a1;
    ...
    .calc-card {
        background: linear-gradient(135deg, rgba(227, 242, 253, 0.98) 0%, rgba(187, 222, 251, 0.98) 100%) !important;
        border-left: 5px solid #2196f3;
        box-shadow: 0 10px 30px rgba(33, 150, 243, 0.2);
    }
    
    .result-card {
        background: linear-gradient(135deg, rgba(232, 245, 233, 0.98) 0%, rgba(200, 230, 201, 0.98) 100%) !important;
        border-left: 5px solid #4caf50;
        box-shadow: 0 10px 30px rgba(76, 175, 80, 0.2);
    }
    
    .gas-card {
        background: linear-gradient(135deg, rgba(255, 243, 224, 0.98) 0%, rgba(255, 224, 178, 0.98) 100%) !important;
        border-left: 5px solid #ff9800;
        box-shadow: 0 10px 30px rgba(255, 152, 0, 0.2);
    }
    
    .safety-card {
        background: linear-gradient(135deg, rgba(255, 235, 238, 0.98) 0%, rgba(255, 205, 210, 0.98) 100%) !important;
