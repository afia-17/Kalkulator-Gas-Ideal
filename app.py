...
<style>
    ...
    /* Background Khusus untuk Setiap Menu */
    .beranda-bg {
        background-image: url('https://picsum.photos/seed/chemlab/1200/800.jpg');
    ...
    .kalkulator-bg {
        background-image: url('https://picsum.photos/seed/calculator/1200/800.jpg');
        background-size: cover;
        background-position: center;
        position: relative;
    }
    ...
    .ensiklopedia-bg {
        background-image: url('https://picsum.photos/seed/books/1200/800.jpg');
        background-size: cover;
        background-position: center;
        position: relative;
    }
    ...
    .ensiklopedia-content {
        position: relative;
        z-index: 2;
    }
    .keselamatan-bg {
        background-image: url('https://picsum.photos/seed/safety/1200/800.jpg');
        background-size: cover;
        background-position: center;
        position: relative;
    }
...
# ===========================================
    ...
    with st.container():
        st.markdown("""
        <div class="tab-container" style="padding: 20px; background: white; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
...
# ===========================================
    ...
    <div class="ensiklopedia-bg">
        <div class="ensiklopedia-content">
